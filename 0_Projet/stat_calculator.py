...
def calculate_win_rate(game_stats):
    ...
    win_rate_string = f"The #{first_player}# win rate on #{second_player}# is #{win_rate}# with #{total}# games."
...
translate_stat_to_win_rate("files/stat.txt",to_write=True) #We translate the stat.txt file to the win_rate.txt file
